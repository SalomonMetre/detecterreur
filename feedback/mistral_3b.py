...
def generate_feedback_ollama(sentence, corrected_sentence, incorrect_word, corrected_word, model_name="ministral-3:3b"):
...
def process_request(sentence, corrected_sentence, err):
    ...
    explanation = generate_feedback_ollama(
        sentence, corrected_sentence, incorrect_word, corrected_word_val, model_name="ministral-3:3b"
    )
    return explanation
